...
if ( isset($_REQUEST['email']) && isset($_REQUEST['token']) )
{
    ...
    if($valid == 1)
    {
        ...
        if($run){
          $success = "Ваша электронная почта подтверждена! Теперь вы можете войти";
        }else{
          $error = "Есть какая-то ошибка!";
        }   
    }
}
?>
...
<head>
    ...
    <link rel="shortcut icon" href="../assets/img/icons/adminlogo.png" />
        ...
        <div class="col-sm-10 col-md-8 col-lg-4 mx-auto d-table h-100">
          <div class="d-table-cell align-middle">
            <div class="text-center">
              <h1 class="h2"> Добро пожаловать <b>RubyMaine</b> </h1>
                ...
                <div class="m-sm-4">
                  ...
                  <form action="" method="POST">
                    <div class="mb-3 text-center">
                      <label class="form-label"><i class="fa fa-id-card-o" aria-hidden="true"></i> Имя пользователя (Login) </label>
                      <input class="form-control form-control-lg" type="text" name="username" placeholder="Введите имя пользователя (Login)..." value="<?php if(isset($username)){echo clean($username);} ?>"/>
                    </div>
                    <div class="mb-3 text-center">
                      <label class="form-label"><i class="fa fa-unlock-alt" aria-hidden="true"></i> Пароль от пользователя (Password) </label>
                      <input class="form-control form-control-lg" type="password" name="password" placeholder="Введите пароль от пользователя ..." />
                    </div>
                    <div>
                    </div>
                    <div class="text-center mt-3">
                      <button type="submit" name="login" class="btn btn-lg btn-success"> Уверенно войти <i class="fa fa-sign-in" aria-hidden="true"></i></button>
                    </div>
                  </form>
                </div>
              </div>
