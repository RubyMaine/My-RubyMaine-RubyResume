...
<?php 
	if(isset($_POST['submit'])){
		...
		if(empty($verify_password)){
	        $valid = 0;
	        $errors[] = 'Пожалуйста, введите подтвердите пароль';
		}
...
<main class="content">
	<div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-md-6">
                <h1 class="h3 mb-3"><strong><i class="fa fa-plus-square" aria-hidden="true"></i> <i class="fa fa-users" aria-hidden="true"></i> Добавить </strong> новое пользователь </h1>
            </div>
				...
				<div class="col-12 col-lg-4 d-flex">
					<div class="card">
						<div class="card-header">
							<h5 class="card-title mb-0"><i class="fa fa-info-circle" aria-hidden="true"></i> Общедоступная информация: </h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="inputUsername" placeholder="Введите полное имя пользователя ..." name="user_full_name">
									</div>
									<div class="mb-3">
										<label class="form-label" for="inputUsername"><i class="fa fa-id-badge" aria-hidden="true"></i> Имя пользователя: </label>
										<input type="text" class="form-control" id="inputUsername" placeholder="Введите имя пользователя ..." name="username">
									</div>
									<div class="mb-3">
										<label class="form-label" for="inputEmail"><i class="fa fa-envelope" aria-hidden="true"></i> E-Mail:</label>
										<input type="email" class="form-control" id="inputEmail" placeholder="Введите адрес электронной почты ..." name="email">
									</div>
								</div>
								...
								<div class="col-md-12">
									...
									<div class="mt-4">
										...
										<div class="form-check form-switch mt-2">
											...
											<input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" checked="" name="status">
										</div>
