...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><i class="align-middle" data-feather="sliders" style="color: red;"></i> Панель управление Menu </h1>
		<div class="row">
						...
						<div class="col-sm-2">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<div class="col mt-0">
											<a class="sidebar-link" style="color: #fff;" href="about.php">
						...
						<div class="col-sm-2">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<div class="col mt-0">
											<a class="sidebar-link" style="color: #fff;" href="education.php">
						...
						<div class="col-sm-2">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<div class="col mt-0">
											<a class="sidebar-link" style="color: #fff;" href="portifolio.php">
						...
						<div class="col-sm-2">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<div class="col mt-0">
											<a class="sidebar-link" style="color: #fff;" href="contact.php">
						...
						<div class="col-sm-2">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<div class="col mt-0">
											<a class="sidebar-link" style="color: #fff;" href="users.php">
						...
						<div class="col-sm-2">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<div class="col mt-0">
											<a class="sidebar-link" style="color: #fff;" href="settings.php">
...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><i class="align-middle" data-feather="sliders" style="color: red;"></i> Панель управление </h1>
		<div class="row">
								...
								<div class="card-body">
									...
									<div class="mb-0">
										<span class="text-success">
											<span class="text-muted"> Общий портфель </span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									...
									<div class="mb-0">
										<span class="text-success">
											<span class="text-muted"> Общий </span>
									</div>
								</div>
							</div>
						</div>
