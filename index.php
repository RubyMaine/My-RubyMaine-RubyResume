...
<section class="home">
    ...
    <div class="content">
        <h3> Добрый времени суток, <br> Я <i class="fa-solid fa-gem" style="color: red;"></i> <?php echo $about['about_name']; ?></h3> </h3>
        <span> <?php echo $about['about_title']; ?></span>
        <p><?php echo $about['about_desc']; ?></p>
        <a href="tel:<?php echo $about['about_hire']; ?>" class="btn"> Есть вопросы? <i class="fas fa-phone"></i> </a>
    </div>
</section>
